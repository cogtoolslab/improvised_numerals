...
var game_core = function(options){
  ...
  this.game_condition = _.sample(['shape','number','number']); // need to actually set condition somewhere at the beginning of game, right? Or just keep in manual
